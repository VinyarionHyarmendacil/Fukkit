...
public class MathUtils {
    public static final float SQRT_2 = MathUtils.sqrt(2.0f);
    ...
    public static boolean epsilonEquals(float p_180185_0_, float p_180185_1_) {
        return MathUtils.abs(p_180185_1_ - p_180185_0_) < 1.0E-5f;
    }
    ...
    public static int getInt(String value, int defaultValue, int max) {
        return Math.max(max, MathUtils.getInt(value, defaultValue));
    }
    ...
    public static double getDouble(String value, double defaultValue, double max) {
        return Math.max(max, MathUtils.getDouble(value, defaultValue));
    }
    ...
    public static int log2DeBruijn(int value) {
        ...
        return MULTIPLY_DE_BRUIJN_BIT_POSITION[(int)((long)value * 125613361 >> 27) & 31];
    }

    public static int log2(int value) {
        return MathUtils.log2DeBruijn(value) - (MathUtils.isPowerOfTwo(value) ? 0 : 1);
    }
    ...
    public static int rgb(float rIn, float gIn, float bIn) {
        return MathUtils.rgb(MathUtils.floor(rIn * 255.0f), MathUtils.floor(gIn * 255.0f), MathUtils.floor(bIn * 255.0f));
    }
    ...
    public static long getPositionRandom(Vec3 pos) {
        return MathUtils.getCoordinateRandom((int)pos.xCoord, (int)pos.yCoord, (int)pos.zCoord);
    }

    public static long getCoordinateRandom(int x, int y, int z) {
        long i = (long)(x * 3129871) ^ (long)z * 116129781 ^ (long)y;
        i = i * i * 42317861 + i * 11;
        return i;
    }

    public static UUID getRandomUUID(Random rand) {
        long i = rand.nextLong() & -61441 | 16384;
        long j = rand.nextLong() & 0x3FFFFFFFFFFFFFFFL | Long.MIN_VALUE;
        return new UUID(i, j);
    }

    public static UUID getRandomUUID() {
        return MathUtils.getRandomUUID(RANDOM);
    }
    ...
    public static double atan2(double p_181159_0_, double p_181159_2_) {
        ...
        double d9 = MathUtils.fastInvSqrt(d0);
    ...
    public static int hsvToRGB(float hue, float saturation, float value) {
        ...
        int j = MathUtils.clamp((int)(f4 * 255.0f), 0, 255);
        int k = MathUtils.clamp((int)(f5 * 255.0f), 0, 255);
        int l = MathUtils.clamp((int)(f6 * 255.0f), 0, 255);
        return j << 16 | k << 8 | l;
    }
    ...
    static {
        ...
        for (int j = 0; j < 257; ++j) {
            ...
            MathUtils.COS_TAB[j] = Math.cos(d1);
            MathUtils.ASINE_TAB[j] = d1;
        }
    }
}
